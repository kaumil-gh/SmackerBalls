    ...
    class BreakoutView extends SurfaceView implements Runnable {
        ...
        public void createBricksAndRestart(){
            ...
            for(int column = 0; column < 16; column++ ){
                for(int row = column; row < 16; row +=2 ){
                    obstacle[numobstacle++] = new Obstacle(row+1, column, brickWidth, brickHeight);
        ...
        public void update() {
            ...
            if(ball.getRect().bottom > screenY){
                ...
                if(lives == 0){
                    ...
                    paused = true;
                    startActivity(new Intent(getApplicationContext(), Level9_lose.class));
            ...
            if(score == numBricks * 10){
                paused = true;
                startActivity(new Intent(getApplicationContext(), Level9_won.class));
