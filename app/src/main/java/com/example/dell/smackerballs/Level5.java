...
public class Level5 extends Activity {
    ...
    class BreakoutView extends SurfaceView implements Runnable {
        ...
        public BreakoutView(Context context) {
            ...
            // Create a ball
            ball = new Ball(screenX, screenY,-300,-400);
        ...
        public void createBricksAndRestart(){
            ...
            for(int column = 0; column < 22; column++ ){
                for(int row = column; row < 21; row +=2 ){
        ...
        public void update() {
            ...
            if(ball.getRect().bottom > screenY){
                ...
                if(lives == 0){
                    ...
                    paused = true;
                    startActivity(new Intent(getApplicationContext(), Level5_lose.class));
            ...
            if(score == numBricks * 10){
                paused = true;
                startActivity(new Intent(getApplicationContext(), Level5_won.class));
