...
public class Level8 extends Activity {
    ...
    class BreakoutView extends SurfaceView implements Runnable {
        ...
        public BreakoutView(Context context) {
            ...
            screenX = size.x;
            screenY = size.y;
            paddle = new Paddle(screenX, screenY,400);
            // Create a ball
        ...
        public void createBricksAndRestart(){
            ...
            int brickWidth = screenX / 24;
            int brickHeight = screenY /34;
            ...
            for(;row<19;row++)
            {
                sp++;
                a-=2;
                for(column = sp +1;column<= a+sp;column++)
                {
                    bricks[numBricks++] = new Brick(row, column, brickWidth, brickHeight);
                }

            }
            for(column = 7;column<18;column++)
            {
                obstacle[numobstacle++] = new Obstacle(21, column, brickWidth, brickHeight);
            }
        ...
        public void update() {
            ...
            if(ball.getRect().bottom > screenY){
                ...
                if(lives == 0){
                    ...
                    paused = true;
                    // Has the player lost?
                    startActivity(new Intent(getApplicationContext(), Level8_lose.class));
            ...
            if(score == numBricks * 10){
                paused = true;
                startActivity(new Intent(getApplicationContext(), Level8_won.class));
